...
import { getOrderHistory, getAddresses } from "@/app/actions/store";
  ...
  useEffect(() => {
    const fetchStats = async () => {
      if (user) {
        ...
        const { data: orders } = await getOrderHistory();
        ...
        const actualTotalSpent = orders?.reduce((sum: number, o: any) => sum + (Number(o.totalAmount) || 0), 0) || 0;
    ...
    <div className="space-y-10">
      ...
      <div className="bg-[#FAF8F5] rounded-2xl p-8 border border-[#EAE2DB]/50 relative overflow-hidden flex items-center gap-6 shadow-sm">
        ...
        <div className="z-10">
          ...
          <h2 className="font-heading text-3xl font-bold text-[#5c2a1c] mb-1">{user?.name || "User"}</h2>
            ...
            <div key={addr.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col relative overflow-hidden">
              <div className="p-6 flex-1">
                ...
                <div className="text-gray-600 text-xs space-y-1.5 leading-relaxed">
                  <p className="font-bold text-[#3A1E14]">{user?.name || "Customer"}</p>
                  <p>{addr.address}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
            ...
            <div className="flex items-center gap-4 border-b border-gray-50 pb-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-medium text-[#3A1E14] text-sm">{user?.name || "User"}</p>
              </div>
            </div>
