...
import { getAddresses, createAddress, updateAddress, deleteAddress } from "@/app/actions/store";
...
export default function AddressesPage() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (editId) {
      // Update
      const { error } = await updateAddress(editId, formData);
      ...
      // Insert
      const { error } = await createAddress(formData);
